...
* **Diseño UX/UI:** [Wireframes Interactivos en Moqups](https://app.moqups.com/1Fd97Kl4smDhAihliqW58kwrSrVz6WAx/view)
...
1. Clona este repositorio:
   ```bash
   git clone https://github.com/ChristianMarquezE/El_Rincon_Del_Vinilo.git